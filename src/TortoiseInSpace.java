...
public class TortoiseInSpace implements KeyEventDispatcher {
	...
	/*
	 * Make the Tortoise move around the screen when the arrow keys are
	 * pressed...
	 */
	...
	private void moveTortoise(int keyPressed) {
		...
		// each arrow key
		System.out.println(keyPressed); // 37 (L), 38 (UP), 39 (R), 40 (DOWN)
		...
		// 3. If the left arrow is pressed, make the tortoise go left. Hint:
		// Make sure to end with the Tortoise facing UP.
		if (keyPressed == 37) {
